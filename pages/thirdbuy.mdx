...
<WritingLayout role="thirdbuy">
  ...
  Romualdo](https://gabrielromualdo.com/). He runs Thirdbuy, a crypto startup
  ...
  worked as an engineering manager and raised a pre-seed (though, it was in a
  time when that was very easy to do for a crypto startup). I was intrigued.

I later had a formal interview, and started working as an intern (as a trial period) from October to mid-November, and then part-time since. I've learned a lot here, including:
